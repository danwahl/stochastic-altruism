...
if __name__ == '__main__':
    ...
    lsls = {'Disturbed': {'dist': 'array', 'val': [False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True]}, \
        ...
        '12': {'dist': 'array', 'val': [9.3, np.nan, 3.0, 4.8, np.nan, 4.4, np.nan, np.nan,11.6, np.nan,2.8, np.nan,7.5, np.nan,5.4, np.nan,12.2, 12.8, 8.8, 4.2, np.nan,1.7, np.nan, np.nan, 9.2, np.nan, 3.8, 19.6, 13.9, 5.6, np.nan, 14.6, 12.7, 18.7, 12.8, 9.5, np.nan, 20.9, np.nan, 6.3, 2.8, 10.1, 16.0, np.nan, 13.4, 11.1, np.nan, 4.5, 4.2, 4.8]}, \
    ...
    filters = {'TDS': {'dist': 'array', 'val': [50, 200, 300, 400]}, \
        ...
        'Pitcher reuses': {'dist': 'const', 'val': 1}
    }
